                    ...
                    <div class="col-lg-5">
                        <div class="feature-car-rent-box-1"
                            ...
                            <ul class="list-unstyled-editable">
                                <li>
                                    <label>Nome</label>
                                    <input type="text" name="editable" class="form-control" id="nome" required>
                                </li>
                                <li>
                                    <label>Cognome</label>
                                    <input type="text" class="form-control" id="cognome" name="editable" required>
                                </li>
                                <li>
                                    <label>Codice fiscale</label>
                                    <input type="text" class="form-control" id="cf" name="editable" required>
                                </li>
                                <li>
                                    <label>Data di nascita</label>
                                    <input type="text" class="form-control" id="nascita" name="editable" required>
                                </li>
                                <li>
                                    <label>Username</label>
                                    <input type="text" class="form-control" id="username" name="editable" required>
                                </li>
                                <li>
                                    <label>Password</label>
                                    <input type="password" class="form-control" id="password" name="editable" required>
                                </li>
                                <li>
                                    <form>
                                        <fieldset>
