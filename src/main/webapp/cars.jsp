...
<div class="site-wrap" id="home-section">
    ...
    <div class="site-section bg-light">
        <div class="container">
            <div class="row">
                <c:forEach items="${veicoli}" var="car">
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="item-1">
                            <a href="#"><img SRC="${car.urlImg}" alt="Image" class="img-fluid" height="1000"
                                             width="1000"></a>
                            <div class="item-1-contents">
                                <div class="text-center">
                                    <h3>${car.costruttore}</h3>
                                    <div class="rating">
                                    ...
                                    <div class="rent-price"><span>$ ${car.prezzo}/</span>day</div>
                                </div>
                                <ul class="specs">
                                    <li>
                                        <span>Modello</span>
                                        <span class="spec">${car.modello}</span>
                                    </li>
                                    <li>
                                        <span>Anno immatricolazione</span>
                                        <span class="spec">${car.annoCostruzione}</span>
                                    </li>
                                    <li>
                                        <span>Tipologia</span>
                                        <span class="spec">${car.tipologia.tipologia}</span>
                                    </li>
                                    <li>
                                        <span>Età minima</span>
                                        <span class="spec">18 anni</span>
                                    </li>
                                </ul>
                                <c:if test="${utente.ruolo.descrizione=='Customer'}">
                                    <div class="d-flex action">
                                        <a class="btn btn-primary"
                                                <c:url value="/rent" var="urlCar">
                                                    <c:param name="idVeicolo" value="${car.id}"/>
                                                </c:url>
                                           href="${urlCar}">
                                            Noleggia ora
                                        </a>
